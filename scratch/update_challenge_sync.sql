-- 1. Redefine ensure_active_challenges to support timezone-aware seeding
...
-- 2. Redefine sync_user_challenges to use timezone-aware seeding, calendar-day cutoff, and dynamic demotion
